...
<article
    ...
    <div class="py-6 px-5 lg:flex">
        <div class="flex-1 lg:mr-8">
            ...
            <img src="img/<?php echo e(asset('storage/' . $post->thumbnail)); ?>.jpg" onerror="this.onerror=null;this.src='/images/picture-svgrepo-com.svg';" alt="Blog Post illustration" class="rounded-xl"/>
        </div>
